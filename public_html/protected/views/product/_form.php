				   		<form id="main-form" action="<?php echo $this->getConfig('base_url');?>/producte<?php echo !empty($product->id)?"/{$product->id}":"";?>" method="<?php echo $method;?>">
			    			...
			    			<div class="form-group">
			    				...
			    				<input type="text" value="<?php echo $product->price;?>" class="form-control" name="price" rows="8" id="price" pattern="\d+(\.\d{1,2})?" title="Camp numèric amb dues xifres decimals." required>
			    				<div class="error"></div>
			    			</div>
			    			...
			    			<div class="form-group">
			    				...
			    				<input type="number" value="<?php echo $product->stock;?>" min="0" step="1" class="form-control" name="stock" id="stock" title="Camp numèric. Valors sencers positius o zero." required>
			    				<div class="error"></div>
			    			</div>
							...
							<div class="form-group">
								<label for="">Esborrar foto</label>
								<input type="hidden" name="remove" id="remove" value="0"/>
					    		<label for="remove"><input type="checkbox" id="remove" name="remove" value="1" class="form-control"> si</label>
					    	</div>
							<!-- status:  -->
			    			<div class="form-group">
