	    			...
	    			<div class="col-4">
	    				<div class="item">
	    					...
	    					<div class="item-footer">
	    						<div class="col-4 button"><i class="fa fa-trash-o"></i></div>
	    						<div class="col-4 button pink"><i class="fa fa-edit"></i></div>
	    					</div>
	    				</div>
	    			</div>
	    			<div class="col-4">
	    				<div class="item">
	    					...
	    					<div class="price">€3.50</div>
	    					<div class="item-footer">
	    						<div class="button"><i class="fa fa-trash-o"></i></div>
	    						<div class="col-4 button pink"><i class="fa fa-edit"></i></div>
	    					</div>
	    				</div>
	    			</div>
