	    	...
	    	<div class="container">
	    		<div class="row">
	    			...
	    			<div class="col-8">
				   		<form action="/usuari" method="<?php echo $method;?>">
			    			...
			    			<div class="form-group">
			    				...
			    				<input type="password" class="form-control" name="password" id="password" patern="[\s\S]{1,30}" title="Camp alfanumèric amb 30 caracters màxim." onchange="this.setCustomValidity(this.validity.patternMismatch ? '30 caràcters màxim.' : ''); if(this.checkValidity()) document.forms[1].password2.pattern = this.value;" required>
			    				<div class="error"></div>
			    			</div>
			    			...
			    			<div class="form-group">
			    				...
			    				<input type="password" class="form-control" name="password2" id="password2" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Les contrasenyes no coincideixen' : '');"  required>
			    				<div class="error"></div>
			    			</div>
